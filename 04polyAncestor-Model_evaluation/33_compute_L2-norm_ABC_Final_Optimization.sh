...
for j in `seq 1 1 8`; do 
    for k in `seq 1 1 3`; do               # populations
    ################## priors folder
       ...
       PP_Obs=/mnt/sda/dingjunyi/data_analysis/costataeEvolution/Result/05ABC_Simulated_annealing/00_PAIRING_PROFILES_${pop[$k]}.txt		
