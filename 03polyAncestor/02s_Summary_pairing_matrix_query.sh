...
TC_ASH="$(grep -w 'TZZ78' ${In_file} | cut -f3)"
TC_COS_ASH="$(grep -w 'QSLC10_TZZ78' ${In_file} | cut -f3)"
TC_BUG="$(grep -w 'CKX18-006' ${In_file} | cut -f3)"
TC_BUG_OUT="$(grep -w 'CKX18-006_QSLC10_TZZ78' ${In_file} | cut -f3)"
TC_MCA="$(grep -w 'XYB21-001-mcalli' ${In_file} | cut -f3)"
TC_MCA_OUT="$(grep -w 'CKX18-006_QSLC10_TZZ78_XYB21-001-mcalli' ${In_file} | cut -f3)"
TC_LEN="$(grep -w 'lenta_ERR2026272' ${In_file} | cut -f3)"
TC_BASAL="$(grep -w 'Alnus_glutinosa_ERR2103731_CKX18-006_EDL21-009-platy_lenta_ERR2026272_nana_ERR2026268_occidentalis_ERR2026271_pendula_ERR2026097_populifolia_ERR2026269_QSLC10_TZZ78_XYB21-001-mcalli' ${In_file} | cut -f3)"
